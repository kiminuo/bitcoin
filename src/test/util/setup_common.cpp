      ...
      m_args_manager{}
{
    ...
    m_args_manager.ForceSetArg("-datadir", m_path_root.string());
    ...
    : ChainTestingSetup(chainName, extra_args)
{
    ...
    m_node.banman = std::make_unique<BanMan>(m_args_manager.GetDataDirPath() / "banlist.dat", nullptr, DEFAULT_MISBEHAVING_BANTIME);
