                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::OBJ, "fee_histogram", "",
                            {
                                {RPCResult::Type::OBJ, "ranges", "Feerate groups",
                                {
                                    {RPCResult::Type::OBJ, "<feerate-group>", "Object per feerate group",
                                    {
                                        ...
                                        {RPCResult::Type::NUM, "fees", "Cumulated fees of all transactions in feerate group"},
                                        {RPCResult::Type::NUM, "from_feerate", "Group contains transactions with feerates equal or greater than this value"},
                                        {RPCResult::Type::NUM, "to_feerate", "Group contains transactions with feerates less than this value"},
                                    }}}},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[0].isNull()) {
        ...
        for (size_t i = 0; i < feelimits_univalue.size(); ++i) {
            CAmount amount = AmountFromValue(feelimits_univalue[i]);
            feelimits.push_back(std::make_pair<>(FormatMoney(amount), amount));
        }
